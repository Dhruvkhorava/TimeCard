...
@section('title', 'Create Employee - Soft UI Dashboard')
  ...
  <div class="col-lg-10 col-md-11 mx-auto">
    <div class="card shadow-lg border-0">
      <div class="card-header pb-0 text-left bg-transparent">
        <div class="row">
          <div class="col-md-8">
            <h3 class="font-weight-bolder text-info text-gradient mb-0">Create New Employee</h3>
            <p class="text-sm text-secondary">Add a new member to the professional workspace.</p>
          </div>
      ...
      <div class="card-body">
        <form role="form" action="{{ route('employee.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="e.g. Michael Jordan" value="{{ old('name') }}">
                </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="michael@company.com" value="{{ old('email') }}">
                </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label class="form-control-label">Standard Password</label>
                <div class="input-group mb-3">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="+1 (555) 123-4567" value="{{ old('phone') }}">
                </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" name="designation" class="form-control @error('designation') is-invalid @enderror" placeholder="e.g. Senior Developer" value="{{ old('designation') }}">
                </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" name="department" class="form-control @error('department') is-invalid @enderror" placeholder="e.g. Engineering" value="{{ old('department') }}">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <select name="status" class="form-control @error('status') is-invalid @enderror">
                    ...
                    <option value="0" {{ old('status') == '0' ? 'selected' : '' }}>On Leave / Inactive</option>
                  </select>
                </div>
